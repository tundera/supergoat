...
const AuthenticatedLayout: FC<Props> = ({ title, children }) => {
...
export const getLayout: GetLayoutFunction = (page) => {
  const Layout = dynamic(() => import('src/layouts/AuthenticatedLayout'), { suspense: true })

  return <Layout>{page}</Layout>
}

const AuthenticatedLayoutErrorFallback = ({ error, resetErrorBoundary }: ErrorFallbackProps) => {
  return (
    <Flex
      direction="column"
      alignItems="center"
