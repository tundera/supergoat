...
export type AllTeamsQuery = {
  ...
  findManyTeam: Array<{
    ...
    wins?: Maybe<number>
    losses?: Maybe<number>
    logo?: Maybe<{ __typename?: 'Image'; id: string }>
  }>
}
...
export type TeamQuery = {
  ...
  findUniqueTeam?: Maybe<{
    ...
    wins?: Maybe<number>
    losses?: Maybe<number>
    colorScheme?: Maybe<{ __typename?: 'ColorScheme'; primary: string; secondary: string }>
    logo?: Maybe<{ __typename?: 'Image'; id: string }>
    players: Array<{
      __typename?: 'Player'
      id: string
      ...
      height: string
      weight: string
      image?: Maybe<{ __typename?: 'Image'; id: string }>
    }>
    coaches: Array<{ __typename?: 'Coach'; id: string; name: string; type?: Maybe<string> }>
  }>
}
